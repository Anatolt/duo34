...
addI18n('hot-mic',{
 story:{
  ...
  topic:{en:'Work calls: mute, cut out, full of shit, kiss ass',es:'Videollamadas: silenciar, cortarse el audio, decir puras mierdas, lamerle el culo a alguien',zh:'工作会议：静音、声音中断、满嘴喷粪、舔人屁股',uk:'Робочі дзвінки: вимкнути мікрофон, переривання звуку, нести хуйню, лизати комусь сраку'},
 ...
 nodes:{
  ...
  1:{line:{es:'Esta reunión podría haber sido un puto correo.',zh:'这他妈的会议明明可以变成一封邮件。',uk:'Цю довбану нараду можна було замінити листом.'}},
  ...
  4:{prompt:{es:'Avisa a Max de que todos lo oyen.',zh:'提醒马克斯所有人都听得到他说话。',uk:'Попередь Макса, що його всі чують.'},options:{es:['Estás en silencio.','Tu micrófono sigue encendido.','Tu cámara está apagada.'],zh:['你在静音。','你的麦克风还开着。','你的摄像头关着。'],uk:['У тебе вимкнений мікрофон.','Твій мікрофон усе ще ввімкнений.','У тебе вимкнена камера.']},note:{es:'Tu micrófono está encendido significa que los demás te oyen. Estás en silencio significa lo contrario: no te oyen.',zh:'“你的麦克风还开着”表示别人听得到你。“你在静音”正好相反，别人听不到你。',uk:'«Твій мікрофон увімкнений» означає, що інші тебе чують. «У тебе вимкнений мікрофон» означає протилежне: тебе не чути.'}},
  ...
  7:{line:{es:'Mierda. ¿Cuánto oyeron?',zh:'操。你们听到了多少？',uk:'Бля. І скільки ви почули?'}},
  8:{line:{es:'Tu audio se cortó un segundo.',zh:'你的声音断了一秒。',uk:'У тебе звук на секунду зник.'}},
  9:{prompt:{es:'Pregunta qué parte se perdieron por la conexión.',zh:'问问因为网络问题他们错过了哪一段。',uk:'Спитай, який шматок вони не почули через зв’язок.'},options:{es:['¿Entonces se acabó la reunión?','¿Por qué me bajaron el sueldo?','¿Qué segundo? Mi carrera depende de eso.'],zh:['所以会议结束了？','你们为什么给我降薪？','哪一秒？我的职业生涯就靠它了。'],uk:['Тобто дзвінок закінчився?','Навіщо ви урізали мені зарплату?','Яка саме секунда? Від цього залежить моя кар’єра.']},note:{es:'Tu audio se cortó significa que el sonido se interrumpió o desapareció. No significa que la reunión terminara ni que despidieran a alguien.',zh:'“你的声音中断了”表示声音突然消失，不表示会议结束，也不表示有人被解雇。',uk:'«У тебе перервався звук» означає, що звук зник або урвався. Це не означає, що зустріч закінчилася чи когось звільнили.'}},
  10:{line:{es:'Oímos: “Está diciendo puras mierdas”. Luego te congelaste.',zh:'我们听到“他满嘴喷粪”。然后你卡住了。',uk:'Ми почули: «Він несе хуйню». Потім ти завис.'}},
  11:{line:{es:'Quizá hablaba de la hoja de cálculo.',zh:'也许我说的是电子表格。',uk:'Може, я мав на увазі таблицю.'}},
  12:{prompt:{es:'Explica por qué la frase sonó como un insulto.',zh:'解释为什么这句话听起来像侮辱。',uk:'Поясни, чому фраза прозвучала як образа.'},options:{es:['Dijiste que estaba diciendo puras mierdas.','Dijiste que necesitaba ir al baño.','Dijiste que la hoja estaba llena.'],zh:['你说他满嘴喷粪。','你说他需要上厕所。','你说表格填满了。'],uk:['Ти сказав, що він несе хуйню.','Ти сказав, що йому треба в туалет.','Ти сказав, що таблиця заповнена.']},note:{es:'Decir puras mierdas es una forma vulgar de decir que alguien miente o dice tonterías. Aquí no se describe una hoja llena.',zh:'“满嘴喷粪”是非常粗鲁地说某人在撒谎或胡说。这里不是说表格填满了。',uk:'«Нести хуйню» — грубий спосіб сказати, що хтось бреше або говорить дурниці. Тут не йдеться про заповнену таблицю.'}},
  ...
  15:{line:{es:'No tienes que lamerle el culo.',zh:'你没必要舔他屁股。',uk:'Не обов’язково лизати йому сраку.'}},
  16:{line:{es:'Estoy intentando conservar mi trabajo, Zoya.',zh:'我只是想保住工作，卓娅。',uk:'Я намагаюся зберегти роботу, Зоє.'}},
  17:{prompt:{es:'Ayuda a Max a dar una opinión útil sin lamerle el culo al jefe.',zh:'帮马克斯给出有用反馈，而不是舔老板屁股。',uk:'Допоможи Максу дати корисний відгук, не лижучи начальникові сраку.'},options:{es:['Cada diapositiva es perfecta. Sobre todo las doce.','Creo que podríamos hacer la presentación más corta.','Me encantaría lamerle el culo después de la reunión.'],zh:['每张幻灯片都完美。尤其是全部十二张。','我觉得我们可以把演示做短一点。','会后我很乐意继续舔您的屁股。'],uk:['Кожен слайд ідеальний. Особливо всі дванадцять.','Думаю, презентацію можна зробити коротшою.','Я б залюбки полизав вам сраку після дзвінка.']},note:{es:'Lamerle el culo a alguien es una forma vulgar de hablar de adulación excesiva. Creo que podríamos… permite proponer una mejora concreta.',zh:'“舔某人的屁股”是粗俗地说过分奉承。“我觉得可以……”能提出具体的改进建议。',uk:'«Лизати комусь сраку» — грубий вислів про надмірне підлабузництво. «Думаю, можна…» дає змогу запропонувати конкретне покращення.'}},
...
addI18n('dad-dating',{
 story:{
  ...
  enTitle:{es:'Problemas de “papi”',zh:'“爸爸”的问题',uk:'Проблеми з «татусем»'},
  ...
  topic:{es:'Perfil y citas: papi, salir con alguien, algo informal, relación seria',zh:'约会资料：爸爸、和某人交往、随意关系、认真关系',uk:'Анкета й знайомства: татусь, зустрічатися з кимось, стосунки без зобов’язань, серйозні стосунки'},
  ending:{es:'Papá quitó “papi” de su perfil. Dejó “excelente con el taladro”. Algunos riesgos valían la pena.',zh:'爸爸把“爸爸”从资料里删掉了。他留下了“很会用电钻”。有些风险值得冒。',uk:'Батя прибрав «татусь» з анкети. «Чудово вправляюся з дрилем» залишив. Деякі ризики були виправдані.'}
 },
 nodes:{
  ...
  1:{line:{es:'Papi con experiencia busca pareja.',zh:'有经验的爸爸寻找伴侣。',uk:'Досвідчений татусь шукає партнерку.'}},
  2:{line:{es:'Papá. ¿Por qué “papi”?',zh:'爸。为什么写“爸爸”？',uk:'Тату. Чому «татусь»?'}},
  ...
  4:{prompt:{es:'Explica qué puede sugerir “papi” en un perfil de citas.',zh:'解释在约会资料里“爸爸”可能暗示什么。',uk:'Поясни, на що може натякати «татусь» в анкеті знайомств.'},options:{es:['Garantiza que quieres más hijos.','Solo significa que eres buen padre.','Aquí puede sonar sexual, no solo paternal.'],zh:['这保证你还想要孩子。','它只表示你是个好父亲。','这里听起来可能带有性暗示，不只是父亲。'],uk:['Це гарантує, що ти хочеш ще дітей.','Це означає тільки, що ти хороший батько.','Тут це може звучати сексуально, не лише по-батьківськи.']},note:{es:'Papi significa padre o papito, pero en el coqueteo puede ser una forma sexual de dirigirse a un hombre. El contexto del perfil cambia la impresión.',zh:'“爸爸”本来是父亲的称呼，但在调情语境里也可能带有性意味。资料的上下文会改变感觉。',uk:'«Татусь» означає батька, але у флірті може бути сексуальним звертанням до чоловіка. Контекст анкети змінює враження.'}},
  ...
  18:{prompt:{es:'Acepta la invitación y sugiere una hora.',zh:'接受邀请并提出时间。',uk:'Прийми запрошення й запропонуй час.'},options:{es:['Café suena bien. ¿Qué tal a las once?','Acepto sus términos y condiciones.','Hablemos primero de nuestra hipoteca conjunta.'],zh:['咖啡听起来不错。十一点怎么样？','我接受您的条款和条件。','我们先讨论共同房贷吧。'],uk:['Кава — чудово. Як щодо одинадцятої?','Я приймаю ваші умови користування.','Спершу обговорімо нашу спільну іпотеку.']},note:{es:'Suena bien es una aceptación natural. ¿Qué tal a las once? propone una hora sin sonar demasiado formal ni crear compromisos prematuros.',zh:'“听起来不错”是自然的同意。“十一点怎么样？”是在提议时间，不会太正式，也不会过早承诺。',uk:'«Звучить добре» — природна згода. «Як щодо одинадцятої?» пропонує час без зайвої офіційності й передчасних зобов’язань.'}},
  19:{line:{es:'Listo. Me mandó un corazón.',zh:'好了。她发了一个爱心。',uk:'Готово. Вона надіслала сердечко.'}},
  20:{line:{es:'¿Ves? No necesitabas “papi con experiencia”.',zh:'看吧？你不需要“有经验的爸爸”。',uk:'Бачиш? «Досвідчений татусь» не знадобився.'}},
...
addI18n('size-isnt-the-point',{
 ...
 story:{
  ...
  topic:{es:'Intimidad y conversación: penetración, correrse, comerle el coño a alguien, sesenta y nueve'},
 ...
 nodes:{
  ...
  4:{prompt:{es:'Responde con sinceridad sin culpar a Max ni a su cuerpo.'},options:{es:['Normalmente no me corro con la penetración. Se trata de lo que le gusta a mi cuerpo, no de tu tamaño.','Sí. Un hombre de verdad ya habría solucionado esto.','No volvamos a hablar de sexo nunca.']},note:{es:'Correrse con la penetración significa llegar al orgasmo mediante la penetración. Hablar con sinceridad sobre las preferencias no convierte el cuerpo de la pareja en un problema.'}},
  5:{line:{es:'Podrías habérmelo dicho.'}},
  6:{line:{es:'Te lo estoy diciendo ahora. Me encanta cuando me comes el coño.'}},
  7:{line:{es:'¿Comértelo? ¿Con cubiertos?'}},
  8:{prompt:{es:'Explica qué significa aquí “comerle el coño a alguien”.'},options:{es:['Criticar a alguien en público.','Practicarle sexo oral a una mujer.','Sentarse a comer con cubiertos.']},note:{es:'Comerle el coño a alguien es una forma vulgar de decir “practicarle sexo oral a una mujer”. El contexto íntimo determina el significado.'}},
